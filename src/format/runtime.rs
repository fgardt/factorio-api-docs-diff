...
#[cfg(feature = "diff")]
use super::diff_helper::{vec_diff, DiffableVec, DiffableVecDiff, Named, SingleDiff};
#[cfg(feature = "non_type_info")]
use super::Image;

#[cfg(not(feature = "diff"))]
use super::FakeDiffableVec as DiffableVec;
...
#[cfg(feature = "diff")]
mod diff_impls {
    use super::super::prototype::{Literal, LiteralDiff, LiteralValue};
    #[allow(clippy::wildcard_imports)]
    use super::*;

    impl super::super::Doc for RuntimeDoc {
    ...
    impl super::super::Info for RuntimeDocDiff {
        fn print_info(&self) {
        ...
        fn diff(&self, updated: &Self) -> Vec<Self::Diff> {
            ...
            match (self, updated) {
                ...
                | (
                    ...
                    Self::LuaLazyLoadedValue { value: u_value },
                ) => {
                    if value != u_value {
                        let diff = value.diff(u_value);
