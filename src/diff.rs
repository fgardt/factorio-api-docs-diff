...
use crate::format::{self, prototype::PrototypeDoc, runtime::RuntimeDoc, Doc as _};
...
thread_local! {pub static CLI: RefCell<Cli> = RefCell::new(Cli::parse());}
thread_local! {pub static SRC_INF: RefCell<format::Common> = RefCell::default();}
thread_local! {pub static TRGT_INF: RefCell<format::Common> = RefCell::default();}
